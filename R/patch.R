...
read_patch_bbs = function(filename = gstream_path("patches/patches_bb.gpkg")){
  sf::read_sf(filename)
}
...
read_patch_month = function(filename = gstream_path("patches/patches_data_month.csv.gz")){
