...
This reads in all of the data stored with the package. We can then do a simple plot of all of the locations. The black lines indicate the most recently posted walls.
...
Here we can look at all of the data for a particular week of the year, with most recent data superimposed.
